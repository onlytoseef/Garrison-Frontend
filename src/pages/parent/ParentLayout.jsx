          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              ...
              >
                ...
                {unreadCount > 0 && (
                  <span className="absolute top-0.5 right-0.5 min-w-[18px] h-[18px] px-1 bg-red-500 text-white text-[11px] leading-none font-bold rounded-full flex items-center justify-center ring-2 ring-[#1E3F72] z-10">
